<?php
// filepath: /d:/xampp/htdocs/doan/php/PageAdmin/PViewExamDetails.php
session_start();
...
<head>
    ...
    <title>Xem chi tiết bài thi</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center">Chi tiết bài thi</h1>
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="card">
    ...
    <script>
        ...
        function confirmBack() {
            if (confirm('Quay lại sẽ không lưu dữ liệu hiện tại. Bạn có chắc chắn muốn quay lại?')) {
                window.location.href = 'PViewUserExams.php?userId=<?= htmlspecialchars($userId) ?>';
            }
        }
    </script>
</body>
